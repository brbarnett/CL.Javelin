...
namespace CL.Javelin.Sales.Client.DesignViewModels
{
    public class BoardPageDesignViewModel
    {
        ...
        {
            this.Requests = await Javelin.Core.Utilities.Http.Get<IEnumerable<Request>>("http://127.0.0.1:9003/fulfillment/getOpenRequests");
        }
    }
}
